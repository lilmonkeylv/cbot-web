...
<html lang="en">
  ...
  <body class="bg-gray-800 font-sans leading-normal tracking-normal">
       ...
       <p class="heading text-center pb-0 pt-0" style="font-size: 42px;">ChillBot Staff</p>
       <div class="pr-20 pl-20 pt-20">
              <div class="bg-gray-700 p-6 rounded-xl shadow overflow-hidden">
                     <h2 class="text-2xl font-bold mb-2 text-gray-100">Developers</h2>
                     <p class="text-gray-100 pl-2">lilmonkeylv#1210</p>
              </div>
       </div>
       <div class="pr-20 pl-20 pt-4 bg-gray-800">
              <div class="bg-gray-700 p-6 rounded-xl shadow overflow-hidden">
                     <h2 class="text-2xl font-bold mb-2 text-gray-100">Support Team</h2>
                     <p class="text-gray-100 pl-2">Rexx#0420</p>
              </div>
       </div>
