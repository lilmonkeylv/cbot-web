...
<style>
       ...
       <div class="flex flex-col md:flex-row">
              ...
              <main class="bg-gray-300 max-w-lg mx-auto p-16 md:p-16 my-10 rounded-lg shadow-2xl w-1/2" style="height: fit-content; margin: auto">
                     <section>
                            <h3 class="font-bold text-2xl text-center">Make a user</h3>
                     </section>
                     <section class="mt-10">
                            <form class="flex flex-col" method="POST" action="../src/includes/users/create.inc.php">
                                   <div class="mb-6 pt-3 rounded-lg bg-gray-200">
                                          ...
                                          required autofocus oninvalid="this.setCustomValidity('Please enter a username!')" oninput="this.setCustomValidity('')" />
                                   </div>
                                   <div class="mb-6 pt-3 rounded-lg bg-gray-200">
                                          ...
                                          required autofocus oninvalid="this.setCustomValidity('Please enter a password!')" oninput="this.setCustomValidity('')" />
                                   </div>
                                   <div class="mb-1 pt-3 rounded-lg bg-gray-200">
                                          <input placeholder="Email" type="text" name="email" id="email" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-200 px-3 pb-3"
                                          required autofocus oninvalid="this.setCustomValidity('Please enter a password!')" oninput="this.setCustomValidity('')" />
                                   </div>
