       ...
       <div class="bg-gray-800 shadow-xl h-16 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48">
              <div class="md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                     <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                            ...
                            <li class="mr-3 flex-1">
                                   <a href="create.staff.php" class="block py-1 md:py-3 pl-1 transition duration-200 ease-in-out align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-600">
                                          <i class="fas fa-user-friends pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-white block md:inline-block">Add a member</span>
                                   </a>
                            </li>
                            <li class="mr-3 flex-1">
                     ...
                     <table class="min-w-full bg-gray-800">
                            <thead class="bg-gray-800 text-white">
                                   <tr>
                                          ...
                                          <th class="text-left py-3 px-4 uppercase font-semibold text-sm" style="font-size: 32px;">Category</th>
                            ...
                            <?php
                                   ...
                                   if ($result->num_rows > 0) { while ($row = $result->fetch_assoc()) { ?>
                                          <thead>
                                                 ...
                                                 <td class="text-left py-3 px-1 text-gray-300"><?php echo $row['category'] ?></td>
                                                 <td class="text-left py-3 px-12 text-gray-300"><?php echo $row['added_by'] ?></td>
                                                 <td class="text-left py-3"><a href="../src/includes/staff/delete.inc.php?updateID=<?php echo $row['id'] ?>"><i class="fas fa-trash-alt transition duration-120 ease-in-out hover:text-red-500 text-gray-300"></i></a></td>
                                          </thead>
                                   <?php }} else { ?>
                                          <tr>
                                                 <td class="w-1/3 text-left py-3 px-8 text-white" style="font-family: Comfortaa; font-size: 14px;">No staff found.</td>
                                          </tr>
                                   <?php }; ?>
                            </tbody>
                     </table>
